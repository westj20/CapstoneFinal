 ...
 * Use the {@link topZoneFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class topZoneFragment extends Fragment {
     ...
     * @return A new instance of fragment topZoneFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static topZoneFragment newInstance(String param1, String param2) {
        topZoneFragment fragment = new topZoneFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (cursor != null && cursor.moveToFirst() && departmentIndex != -1 && zoneIndex != -1 && totalScoreIndex != -1) {
            ...
            // Sort all scores in descending order based on total scores
            Collections.sort(allScores, (o1, o2) -> o2.getValue().compareTo(o1.getValue()));
